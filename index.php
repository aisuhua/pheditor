...
define('MAIN_DIR', __DIR__ . '/storage');
...
<head>
	...
	<link rel="stylesheet" href="static/lint.min.css">
	<link rel="stylesheet" href="static/dialog.min.css">
	<link rel="stylesheet" href="static/monokai.css">
	<?php if (empty(EDITOR_THEME) === false) : ?>
		<link rel="stylesheet" href="static/<?= EDITOR_THEME ?>.css">
	<?php endif; ?>
	<link rel="stylesheet" href="static/iziToast.min.css">
	...
	<script src="static/php.min.js"></script>
	<script src="static/xml.min.js"></script>
	<script src="static/htmlmixed.js"></script>
	<script src="static/markdown.js"></script>
	<script src="static/clike.min.js"></script>
	<script src="static/jshint.min.js"></script>
	<script src="static/jsonlint.min.js"></script>
	<script src="static/lint.min.js"></script>
	<script src="static/javascript-lint.min.js"></script>
	<script src="static/json-lint.min.js"></script>
	<script src="static/css-lint.min.js"></script>
	<script src="static/search.min.js"></script>
	<script src="static/searchcursor.min.js"></script>
	<script src="static/jump-to-line.min.js"></script>
	<script src="static/dialog.min.js"></script>
	<script src="static/iziToast.min.js"></script>
	...
	<script type="text/javascript">
        ...
        //     setTimeout(function () {
        //         var $tmp = $('#files .jstree-clicked');
        //         $('#files .jstree-ocl').eq(2).click();
        //         $tmp.click();
        //     }, 1000);
        // }
	</script>
